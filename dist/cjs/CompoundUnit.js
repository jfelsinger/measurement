...
const combineUnitMultipliers_1 = __importDefault(require("./lib/combineUnitMultipliers"));
const getUnitTypeName_1 = __importDefault(require("./lib/getUnitTypeName"));
/**
...
class CompoundUnit {
    ...
    get unitType() { return UnitType_1.default.Compound; }
    /**
     ...
     */
    get multiplier() {
        return (0, combineUnitMultipliers_1.default)(this.subUnits);
    }
    ...
    convert(unit, index = 0) {
        ...
        if (!unit.matchesType(units[index]))
            throw new Error('Invalid Units: a unit of type `' +
                (0, getUnitTypeName_1.default)(units[index]) +
                '` cannot be converted to a unit of type `' +
                (0, getUnitTypeName_1.default)(unit) +
                '`');
        units[index] = unit;
     ...
     * */
    matchesType(unit) {
        if (unit.unitType !== UnitType_1.default.Compound)
            return false;
        let compound = unit;
