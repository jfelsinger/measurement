...
const bases = [
    ...
    { base: new UnitBase({ abbr: 'oz', name: 'ounce' }), baseUnit: metric.gram, multiplier: 28.349523125 },
    { base: new UnitBase({ abbr: 'lb', name: 'pound' }), baseUnit: metric.gram, multiplier: 453.59237 },
    { base: new UnitBase({ abbr: 'st', name: 'stone' }), baseUnit: metric.gram, multiplier: 6350.29318 },
    { base: new UnitBase({ abbr: 't', name: 'ton' }), baseUnit: metric.units.kg, multiplier: 1016.0469088 },
];
