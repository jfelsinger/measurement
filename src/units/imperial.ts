...
const bases = [
    ...
    { base: new UnitBase({ abbr: 'oz', name: 'ounce'  }), metricBase: metric.gram, multiplier: 28.349_523_125 },
    { base: new UnitBase({ abbr: 'lb', name: 'pound'  }), metricBase: metric.gram, multiplier: 453.592_37 },
    { base: new UnitBase({ abbr: 'st', name: 'stone'  }), metricBase: metric.gram, multiplier: 6350.293_18 },
    { base: new UnitBase({ abbr: 't', name: 'ton'  }), metricBase: metric.units.kg, multiplier: 1016.046_9088 },
];
