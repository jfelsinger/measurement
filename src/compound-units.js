...
CompoundUnit.prototype['addUnit'] = CompoundUnit.prototype.addUnit = function(unit) {
    this['subUnits'][this['subUnits'].length] = unit;
};
...
CompoundUnit.prototype['getMultiplier'] = CompoundUnit.prototype.getMultiplier = function() {
